...
* chrome 插件
   @@ ${}区别 maven build  ----- > deploy package 
     dev ，pro  //@Profile({"dev","sit","uat","pre","pro"}) //一般生产环境不允许日志打印参数
    2.写日志演进blog---》 mybatis plus--->测试异步log
    responebody--->valid rusltmap
    test------> jococo--->sonalint ---->
    多模块互用项目搭建
    1.衣服，鞋子 

    Kafka---->rabbit--->
    
    https://www.cnblogs.com/orzlin/p/9717399.html   SpringBoot+Mybatis多模块（module）项目搭建教程
## 搭建
### 搭建考虑
1. 目录管理
   1. 对象目录
...
16. devops搭建:jekins/编译时检查规范SonarLint
...
## 数据库生产表dataGrip
  * [数据库界的 Swagger，一键自动生成 Java 实体类和数据库文档！不讲武德！](https://mp.weixin.qq.com/s/UPh0--gqPLQsYJAmARjbyQ)
